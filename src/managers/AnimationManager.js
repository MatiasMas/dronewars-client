export class AnimationManager {
    ...
    static preload(scene) {
        ...
        scene.load.spritesheet("effectsBombShot", "assets/effects/Bomba_Disparo.png", {
            frameWidth: 48,
            frameHeight: 48,
        });
        scene.load.spritesheet("effectsBombImpact", "assets/effects/Bomba_Impacto.png", {
            frameWidth: 48,
            frameHeight: 48,
        });
        scene.load.spritesheet("effectsMissileShot", "assets/effects/Misil_Disparo.png", {
            frameWidth: 48,
            frameHeight: 48,
        });
        scene.load.spritesheet("effectsMissileImpact", "assets/effects/Misil_Impacto.png", {
            frameWidth: 48,
            frameHeight: 48,
        });
        scene.load.spritesheet("effectsExplosion", "assets/effects/Explosion.png", {
            frameWidth: 48,
            frameHeight: 48,
        });
    }
